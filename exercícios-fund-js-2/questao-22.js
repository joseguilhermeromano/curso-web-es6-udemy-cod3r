const enunciado = `22)Desenvolva uma função que receba como parâmetro um número de 1 a 10. Internamente, na função, será
...
const funcaoDaSorte = (num) => {
    ...
    let complemento = num == sorteado ? 'Parabéns!' : 'Que pena!'

    return `${complemento} O número sorteado foi o ${sorteado}.`
